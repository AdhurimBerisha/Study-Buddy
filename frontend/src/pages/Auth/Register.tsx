    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex flex-col w-full">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`
                border rounded-lg px-4 py-3 w-full pl-12 pr-12 transition-all duration-200
                ${
                  errors.password
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <button
            type="button"
            className="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors duration-200"
          >
