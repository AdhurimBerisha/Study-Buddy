  ...
  if (loadingTutors) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-lg font-medium text-gray-600 dark:text-gray-400">Loading tutors...</p>
      </div>
    );
  }
  ...
  if (tutors.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-lg font-medium text-gray-600 dark:text-gray-400">No tutors found</p>
        <p className="text-sm text-gray-500 dark:text-gray-500 mt-1">Create your first tutor account to get started</p>
      </div>
    );
  }
    ...
    <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-xl rounded-2xl overflow-hidden border border-white/20 dark:border-gray-700/30">
      <div className="px-6 py-4 border-b border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-purple-50/50 to-pink-50/50 dark:from-purple-900/20 dark:to-pink-900/20">
        <div className="flex items-center space-x-3">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Tutors List</h3>
        </div>
      </div>
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <div className="flex items-center">
                    ...
                    >
                      <svg className={`w-3 h-3 mr-1 ${tutor.isVerified ? 'text-green-600' : 'text-yellow-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        {tutor.isVerified ? (
