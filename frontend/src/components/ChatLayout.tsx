...
const ChatLayout = () => {
  ...
  if (myGroups.length === 0) {
    return (
      <div className="fixed bottom-0 right-2 sm:right-4 lg:right-6 z-50 w-64 sm:w-72 h-14 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-xl rounded-t-xl flex items-center justify-center">
        <div className="text-center text-gray-500 dark:text-gray-400 text-xs sm:text-sm px-3">
    ...
    >
      ...
      {isChatWidgetOpen && (
        <div className="flex flex-1 overflow-hidden">
          <div className="w-1/3 sm:w-64 border-r border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 overflow-y-auto">
            {myGroups.map((group) => (
              <button
                key={group.id}
        ...
        ${
          selectedGroupId === group.id
            ? "bg-white dark:bg-gray-600 border-blue-500 text-blue-700 dark:text-blue-300 font-semibold shadow-sm"
            : "border-transparent hover:bg-gray-100 dark:hover:bg-gray-600 hover:border-gray-300 dark:hover:border-gray-500 text-gray-700 dark:text-gray-300"
        }`}
                onClick={() => {
                  if (selectedGroupId) {
                    socketService.leaveGroup(selectedGroupId);
          ...
          <div className="flex flex-col flex-1">
            <div
              className="flex-1 overflow-y-auto p-3 sm:p-4 lg:p-6 space-y-3 sm:space-y-4 bg-white dark:bg-gray-800"
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 p-3 sm:p-4 flex items-center space-x-2 sm:space-x-3 bg-gray-50 dark:bg-gray-700">
              <input
                type="text"
                placeholder="Type a message..."
                className="flex-1 rounded-lg border border-gray-300 dark:border-gray-600 px-3 sm:px-4 py-2 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500"
                value={newMessage}
              ...
              <button
                ...
                className="bg-blue-500 hover:bg-blue-600 disabled:bg-gray-300 dark:disabled:bg-gray-600 text-white p-2 sm:p-3 rounded-lg transition-colors duration-200 flex items-center justify-center"
              >
      ...
      {!isChatWidgetOpen && (
        <div className="flex items-center justify-center h-full text-gray-500 dark:text-gray-400 italic text-xs sm:text-sm px-3">
